...
<!-- //// -->
<title>Request Form A to B</title>
</head>
<body>
...
<div class="container p-5 my-5 bg-dark text-white"> <!-- For sending Item request to Branch B -->
         <form action="Sent_AB" method="POST">
                    <!-- Tables to Add data  -->
                    ...
                    <div class="modal-footer"> 
                        ...
                        <a class="btn btn-outline-success"  href="/BranchA"  >Return</a> 
                        <button type="submit" name="reqb" class="btn btn-primary">Send Request</button> 
